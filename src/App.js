                    ...
                    <form onSubmit={this.handleSubmit}>
                        <Card className="card">
                            ...
                            <div className="radio-buttons">
                                ...
                                />
                                <label className="radio" htmlFor="manualRadio">Manualna</label>
                                <RadioButton className="gearbox-radio-button"
                                             ...
                                             onChange={this.handleRadioChange}
                                />
                                <label className="radio" htmlFor="automaticRadio">Automatyczna</label>
                            </div>
                            <div className="radio-buttons">
                                <h4>Typ silnika</h4>
                                ...
                                />
                                <label className="radio" htmlFor="dieselRadio">Diesel</label>
                                <RadioButton className="fueltype-radio-button"
                                             ...
                                             onChange={this.handleRadioButtonChange}
                                />
                                <label className="radio" htmlFor="gasolineRadio">Benzyna</label>
                                <RadioButton className="fueltype-radio-button"
                                             ...
                                             onChange={this.handleRadioButtonChange}
                                />
                                <label className="radio" htmlFor="electricRadio">Elektryk</label>
                                <RadioButton className="fueltype-radio-button"
                                             inputId="hybridRadio"
                                             name="fuelType"
                                             value="Hybryda"
                                             ...
                                             onChange={this.handleRadioButtonChange}
                                />
                                <label className="radio" htmlFor="hybridRadio">Hybryda</label>
                            </div>
